...
(function($) {
	...
	(function(g, n, f) {
		...
		var u = g.requestAnimationFrame || g.webkitRequestAnimationFrame || g.mozRequestAnimationFrame || g.oRequestAnimationFrame || g.msRequestAnimationFrame || function(a) {
		...
		p.prototype = {
				...
				if (this.enabled && d.eventType[a.type] === this.initiated) {
					...
					if (!this.resetPosition(this.options.bounceTime))
						if (this.scrollTo(e, k), this.moved)
							...
							destination: e,
							duration: 0
						}, c = this.hasVerticalScroll ? d.momentum(this.y, this.startY, c, this.maxScrollY,
			...
			_initIndicators: function() {
				...
				this.options.scrollbars && (this.options.scrollY && (d = {
						el: s("v", b, this.options.scrollbars),
						interactive: b,
						defaultScrollbars: !0,
						customStyle: c,
					...
					e.push(d)), this.options.scrollX && (d = {
					el: s("h", b, this.options.scrollbars),
					interactive: b,
					defaultScrollbars: !0,
					customStyle: c,
					resize: this.options.resizeScrollbars,
				...
				this.on("refresh", function() {
					...
					if (this.wrapperWidth && this.wrapperHeight && this.scrollerWidth && this.scrollerHeight) {
						if (!0 === this.options.snap)
							for (d = f.round(e / 2), h = f.round(m / 2); g > -this.scrollerWidth;) {
								this.pages[a] = [];
	...
	$.fn.mdatetimer = function(opts) {
		...
		var picker = {
			init: function() {
				...
				if (option.mode == 1) {
					//把不该显示的删除掉
					$('.mt_body', container).css('height', 400);
